...
const Signup = () => {
  ...
  const [association, setAssocationName] = useState("")
  ...
  const handleLogin = async (event) => {
    ...
    // Depending on the active tab, handle specific signup logic
    if (activeTab === "user") {
      alert("User account created successfully");
    } else if (activeTab === "academy") {
      alert("Academy account created successfully");
              ...
              <form className="space-y-6" action="#" method="POST">
                ...
                <div className="mt-2">
                  <input
                    ...
                    name="email"
                    type="email"
                    onChange={(e) => setAssocationName(e.target.value)}
                    autoComplete="email"
                    required
                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
